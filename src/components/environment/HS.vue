<template>
  <div class="main">
    ...
    <div class="query">
      ...
      <div class="select">
        <el-select v-model="HS_id" class="m-2" placeholder="硫化氢#1" size="large">
          <el-option
              v-for="item in HS_id_list"
              :key="item.value"
              :label="item.label"
              :value="item.value"
          />
    ...
    <div class="chart">
      <span>单位：mg/m³</span>
      <div class="chartPlace" id="HSchart">
      </div>
    </div>
  </div>
</template>
    ...
    initchart(){
      ...
      var HSOption =  {
        ...
        series: [
          {
            name:'硫化氢浓度',
            data: [0.15, 0.21, 0.09, 0.21, 0.16, 0.29, 0.30,0.18, 0.21, 0.10],
            type: 'line'
          }
        ]
      };
