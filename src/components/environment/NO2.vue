<template>
  <div class="main">
    ...
    <div class="query">
      ...
      <div class="select">
        <el-select v-model="NO2_id" class="m-2" placeholder="二氧化氮#1" size="large">
          <el-option
              v-for="item in NO2_id_list"
              :key="item.value"
              :label="item.label"
              :value="item.value"
          />
    ...
    <div class="chart">
      <span>单位：mg/m³</span>
      <div class="chartPlace" id="NO2chart">
      </div>
    </div>
  </div>
</template>
    ...
    initchart(){
      ...
      var NO2Option =  {
        ...
        series: [
          {
            name:'二氧化氮浓度',
            data: [1.5, 2.1, 1.9, 1.1, 2.6, 2.3, 1.3,1.2, 2.1, 2.4],
            type: 'line'
          }
        ]
      };
