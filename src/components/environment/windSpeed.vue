<template>
  <div class="main">
    ...
    <div class="query">
      ...
      <div class="select">
        <el-select v-model="speed_id" class="m-2" placeholder="风速#1" size="large">
          <el-option
              v-for="item in speed_id_list"
              :key="item.value"
              :label="item.label"
              :value="item.value"
          />
    ...
    <div class="chart">
      <span>单位：m/s</span>
      <div class="chartPlace" id="speedchart">
      </div>
    </div>
  </div>
</template>
    ...
    initchart(){
      ...
      var speedOption =  {
        ...
        series: [
          {
            name:'风速',
            data: [3.5, 3.1, 3.9, 3.1, 3.6, 2.9, 2.3,3.2, 2.7, 3.4],
            type: 'line'
          }
        ]
      };
