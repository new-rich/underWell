<template>
  <div class="main">
    ...
    <div class="query">
      ...
      <div class="select">
        <el-select v-model="O2_id" class="m-2" placeholder="氧气#1" size="large">
          <el-option
              v-for="item in O2_id_list"
              :key="item.value"
              :label="item.label"
              :value="item.value"
          />
    ...
    <div class="chart">
      <span>单位：mg/m³</span>
      <div class="chartPlace" id="O2chart">
      </div>
    </div>
  </div>
</template>
    ...
    initchart(){
      ...
      var O2Option =  {
        ...
        series: [
          {
            name:'氧气浓度',
            data: [320, 293, 282, 312, 279, 281, 311,301, 288, 264],
            type: 'line'
          }
        ]
      };
