<template>
  <div class="main">
    ...
    <div class="query">
      ...
      <div class="select">
        <el-select v-model="fan_id" class="m-2" placeholder="通风机#1" size="large">
          <el-option
              v-for="item in fan_id_list"
              :key="item.value"
              :label="item.label"
              :value="item.value"
          />
    ...
    <div class="chart">
      <div class="chartPlace" id="fanchart">
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    initchart(){
      var fanchart = echarts.init(document.getElementById('fanchart'));
      var fanOption =  {
        title:{
          text:'通风机工作启停状态',
          left: 'center'
